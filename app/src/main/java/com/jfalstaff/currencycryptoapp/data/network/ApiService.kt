package com.jfalstaff.currencycryptoapp.data.network
...
interface ApiService {
    ...
    companion object {
        ...
        private const val CRYPTO_API_KEY = com.jfalstaff.currencycryptoapp.BuildConfig.CRYPTO_COMPARE_API_KEY
